  ...
  return (
    <div id="home" className="w-full flex flex-col justify-center gap-10 min-h-screen max-container xl:flex-row">
      ...
      >
        ...
        <h1 className="mt-10 text-justify font-palanquin text-8xl max-sm:text-[39px] max-sm:leading-[39px] font-bold">
          <span className="relative z-10 md:pr-10 xl:bg-white xl:whitespace-nowrap">The New Arrival</span>
